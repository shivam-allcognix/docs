...
> A complete platform for running AI models through a unified API and web interface.
...
<Steps>
  ...
  <Step title="Unified Request Format">
    You send a generation request to a single endpoint (<code>/v1/mmk-generate</code>) regardless of the model type.
  </Step>
...
- Good for automation tools or IDE integrations
...
graph TB
    ...
    J[Document Upload] --> K[Document Processing]
    K --> L[Chunking]
    L --> M[Embedding Generation]
    M --> N[Vector Storage]
    
    O[Collections] --> P[Document Management]
    P --> Q[Metadata Storage]
```

## Getting Started

<Card title="Quick Start Guide" icon="rocket" href="/quickstart">
  Get up and running with RAG Studio in 5 minutes.
</Card>
...
<Card title="Try the Web Interface" icon="globe" href="https://rag.allcognix.com">
  Test RAG Studio features using our web interface.
</Card>